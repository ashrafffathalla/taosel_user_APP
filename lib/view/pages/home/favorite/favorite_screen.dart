    ...
    return Scaffold(
         ...
         body:BlocConsumer<FavouriteCubit,FavouriteState>(
             ...
             builder: (context, state) {
               return state is GetFavouriteLoadingState?const Center(child: CircularProgressIndicator.adaptive()):SingleChildScrollView(
                 child: Column(
                   children: [
                     cubit.favouriteModel!.data!.isEmpty?Center(
                       child: Column(
                         children: [
                           SizedBox(
